# Rirekisho Studio Documentation Index

このプロジェクトは、日本国内の利用者が個人情報を自分の端末内で管理しながら履歴書を作成するブラウザアプリです。
...
| `TECH_SPEC.md` | React/Vite、IndexedDB、PDF生成、JSON保存、Cloudflare Workers配備 |
